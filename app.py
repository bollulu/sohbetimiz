...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'sohbetimiz-2026-final'
...
def handle_msg(data):
    ...
    emit('message', {'id': msg.id, 'user': current_user.username, 'msg': data['msg'], 'time': now, 'avatar': current_user.avatar}, to=room)
