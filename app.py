...
# Yeni bir veritabanı dosyası adı (db şemasını temizlemek için)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'chat_v25_final.db')
...
# Aktif kullanıcıları tutan sözlük
online_users = {}
...
def register():
    if request.method == 'POST':
        ...
        av = request.form.get('avatar_choice')
...
if __name__ == '__main__':
    # Render ve yerel ortam için uygun port ayarı
